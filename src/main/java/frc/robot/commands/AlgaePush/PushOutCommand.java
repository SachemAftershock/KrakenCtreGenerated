...
public class PushOutCommand extends Command {
    private final AlgaePushSubsystem mAlgaePush;
    private final int targetRotation = 70;

    /**
     * Creates a new PushOutCommand.
     *
     * @param algaePushSubsystem The AlgaePushSubsystem used by this command.
     */
    public PushOutCommand(AlgaePushSubsystem algaePushSubsystem) {
    ...
    public boolean isFinished() {
        return Math.abs(mAlgaePush.getPushPosition() - targetRotation) <= PusherConstants.kTolerance;
    }
